...
rules: [/^(?:\s+)/,/^(?:[a-eg-su-z])/,/^(?:[TF])/,/^(?:=)/,/^(?:->)/,/^(?:<-)/,/^(?:NAND\b)/,/^(?:NOR\b)/,/^(?:\|)/,/^(?:[X])/,/^(?:&)/,/^(?:!)/,/^(?:\()/,/^(?:\))/,/^(?:$)/,/^(?:.)/],
